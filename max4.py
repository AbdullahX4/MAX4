...
\033[1;92m[+] AUTHOR       :   Mohammed Abdullah 
\x1b[1;92m[+] FACEBOOK     :   Mohammed Abdullah 
\x1b[1;92m[+] GITHUB       :   Abdullah
...
if 'ABDULLAH'==user and 'MAX4'==pas:
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/Mohammed.Abdullah.04')
